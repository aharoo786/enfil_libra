...
class MyRoutinesScreen extends StatelessWidget {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Expanded(
                          ...
                          children: [
                            tabBarViewWidget(
                                habitController.getUserHabitUser!.data),
                            tabBarViewWidget(habitController.morningHabits),
                            tabBarViewWidget(habitController.eveningHabits),
                            tabBarViewWidget(habitController.nightHabits),
                            tabBarViewWidget(habitController.evertTimeHabits),
                          ],
                        )),
                      ],
                    )))
  ...
  tabBarViewWidget(List<UserHabit> userHabits) {
    return RefreshIndicator(
      ...
      child: SingleChildScrollView(
        ...
        child: ListView.separated(
          ...
          shrinkWrap: true,
          itemBuilder: (context, index) => CustomRoutineWidget(
